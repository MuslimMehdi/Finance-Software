...
if __name__ == "__main__":
    DB = file_management()
    account_exist=str(input("Do you want to create a new account? (Y/N): "))
    match account_exist:
        case "Y":
            full_name = input("Enter full name:\n ")
            username = input("Enter username(like first_name,nickname or anything):\n ")
            password = input("Enter a strong password(like ): ")
            email = input("Enter your email address:\n ")
            phone = input("Enter your phone number:\n ")
            address = input("Enter your address:\n ")
            currency = input("Enter your currency (like USD, PKR, EUR, or anything else): ")
            balance = 0
            DB.new_user( full_name, username, password, email, phone, address, currency, balance)
    # Initialize accounts
